package ai.gelej.brownie.ingredient.parsing;

import ai.gelej.brownie.ingredient.Language;
import ai.gelej.brownie.ingredient.NutritionFacts;
...
class EnglishIngredientParserTest {
    ...
    void parse_wellFormedMessage_extractsFactsInOrder() {
        ...
        //then
        assertThat(facts).contains(new NutritionFacts("Chocolate brownie",
    ...
    void parse_blankAndWhitespaceLines_areIgnored() {
        ...
        //then
        assertThat(facts).map(NutritionFacts::name).contains("Chocolate brownie");
